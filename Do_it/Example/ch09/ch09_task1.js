// < 9장 도전과제 1 >
// 프로필 화면에서 프로필을 수정할 수 있는 기능을 추가하라.
...
var configModule = require("./Module_task1/config");
var databaseModule = require("./Module_task1/database");
var routerModule = require("./Module_task1/router_loader");
...
// 라우터 설정
var routerPassportModule = require("./Module_task1/router_passport");
routerPassportModule(expressApp, passport);

// 패스포트 설정
var passportModule = require("./Module_task1/passport");
